                ...
                <div class="single-products">
                        <div class="productinfo text-center"  style="height: 40rem">
                            <a href="{{url("/products/show/$product->id")}}"  style="height: 35rem">
                                ...
                                <h2 style="height: 5rem">{{number_format($product->pivot->count * $product->sale_price ,2)}} JD</h2>
                                @else
                                <h2 style="height: 5rem">{{number_format($product->pivot->count * $product->price ,2)}} JD</h2>
                                @endif
                                </h2>
            ...
            <div class="col-sm-12">
                <div class="total_area">
                    <ul>
                        ...
                        <li>Order price <span>{{number_format($orderPrice ,2)}} JD</span></li>
                        <li>Shipping <span>{{number_format($shipping ,2)}} JD</span></li>
                        <li>Total price <span>{{number_format($totalPrice ,2)}} JD</span></li>
                    </ul>
