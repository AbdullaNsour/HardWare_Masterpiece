                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner col-sm-12">
                        <div class="item active">
                            <div class="col-sm-11">
                                <img src="{{ asset("images/home/slid1.png") }}" class=" img-responsive" alt="" />
                                {{-- <img src="{{ asset("images/home/pricing.png") }}"  class="pricing" alt="" /> --}}
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-sm-11">
                                <img src="{{ asset("images/home/slid2.png") }}" class=" img-responsive" alt="" />
                                {{-- <img src="{{ asset("images/home/pricing.png") }}"  class="pricing" alt="" /> --}}
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="col-sm-11">
                                <img src="{{ asset("images/home/slid3.png") }}" class=" img-responsive" alt="" />
                                {{-- <img src="{{ asset("images/home/pricing.png") }}" class="pricing" alt="" /> --}}
                            </div>
                        </div>
