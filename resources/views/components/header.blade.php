<header id="header"><!--header-->
    <div class="header_top"><!--header_top-->
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo pull-left" style="padding-right:25px">
                        {{-- <a href="{{url('/index')}}"><img src="{{ asset("images/home/logo.png")}}" alt="" /></a> --}}
                        <a href="{{url('/index')}}"><h1>Nsour</h1> </a>

                    </div>
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +962 799601893</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i>alnsour@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <ul class="nav navbar-nav ">
                                ...
                                <li class="dropdown" style="padding-left:25px"><a href="{{url('/profile')}}">{{$cart->user->name}}<i class="fa fa-angle-down"></i></a>
